...
namespace CrossFunctionOverrideFacadeExample
{
    public class Function
    {
        ...
        private IModelStore<CrossFunctionOverrideFacadeExampleInputs> store;

        public async Task<CrossFunctionOverrideFacadeExampleOutputs> Handler(CrossFunctionOverrideFacadeExampleInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<CrossFunctionOverrideFacadeExampleInputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<CrossFunctionOverrideFacadeExampleInputs,CrossFunctionOverrideFacadeExampleOutputs>(store, CrossFunctionOverrideFacadeExample.Execute);
